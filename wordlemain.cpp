 ...
 */
/********************************************************************************************/
/* Code to copy into Wordle.cpp <- replace this with each group member’s name                                                        */
/********************************************************************************************/
...
void reset_ans_list();
//int strcmp ( const char * guess, const char * curr_word );
...
// * *******************************************************************************
//*/
//	doWordsMatch("match","match");
//	doWordsMatch("match","matcy");
//	doWordsMatch("match", "gummy");
//	doWordsMatch("matcy","match");
//
///********************************************************************************
// * PART 1b:
...
//	char ans1[5] = {' ',' ',' ',' ',' '};
//	bool found1[5]={0,0,0,0,0};
//	findGs("match","match",ans1,found1);
//	char ans2[5] = {' ',' ',' ',' ',' '};
//	bool found2[5]={0,0,0,0,0};
//	findGs("match","walsh",ans2,found2);
//	char ans3[5] = {' ',' ',' ',' ',' '};
//	bool found3[5]={0,0,0,0,0};
//	findGs("match","amaze",ans3,found3);
//	char ans4[5] = {' ',' ',' ',' ',' '};
//	bool found4[5]={0,0,0,0,0};
//	findGs("match","mooch",ans4,found4);
//
//
///********************************************************************************
// * PART 1c:
...
//	char a1[] = {'G','G',' ',' ','G'};
//	bool f1[] = {1,1,0,0,1};
//	findYs("match","marsh",a1,f1);
//	char a2[] = {' ',' ',' ',' ',' '};
//	bool f2[] = {0,0,0,0,0};
//	findYs("enter","rests",a2,f2);
//	char a3[] = {' ',' ',' ',' ',' '};
//	bool f3[] = {0,0,0,0,0};
//	findYs("rests","enter",a3,f3);
//	char a4[] = {' ',' ',' ',' ',' '};
//	bool f4[] = {0,0,0,0,0};
//	findYs("enter","teeth",a4,f4);
//	char a5[] = {' ',' ','G',' ',' '};
//	bool f5[] = {0,0,1,0,0};
//	findYs("mommy","simon",a5,f5);
...
bool doWordsMatch(string guess, string curr_word) {
	/* write code here  - see in main for instructions */
	if (guess != curr_word){
			cout << guess << " and " << curr_word << " do not match :-( "  << endl;
	}
		else {
			cout << guess << " and " << curr_word << " are matches!! :-) " << endl;
	}
	return 0;
}
...
void findGs(string guess, string curr_word,char ans[], bool found[]) {
	...
	for (int i = 0; i < 5; i++){
		...
		//How to change empty character to a G
			//How to change 0s to 1, works when true is set under else
	}
	cout << endl;
	cout << "**********************************" << endl;
	//for (int i = 0; i < 5; i++ ) {
